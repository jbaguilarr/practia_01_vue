var app = new Vue({
        ...
        producto :
            ...
            [
                ...
                },
                {
                    id:4,
                    imagen:
                    "https://ae01.alicdn.com/kf/S552326188797415ab6c729f850ab2639R/Dron-Profesional-4K-con-GPS-8K-c-mara-HD-3-ejes-card-n-antivibraci-n-evitaci.jpg_Q90.jpg_.webp",
    ...
    methods: {
        ...
        seleccionarColor : (value,codigo)=> {
             app.pedido.color = value;
             app.pedido.id = codigo;
             app.validarComprar();
        },
         validarComprar: ()=> {
             var valido = false;
             
             if(app.pedido.cantidad < 1 ) valido = true;
             if(app.pedido.id == null) valido = true;
             if(app.pedido.color == null) valido = true;
